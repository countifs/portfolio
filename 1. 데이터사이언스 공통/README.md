...
- **제작동기** : 해당 프로그램은 직업상담사인 아내를 위해 제작하게 되었습니다. tkinter를 통해서 gui를 구성하였고, 워크넷(worknet) 구인번호를 입력하면, 해당 채용공고의 정보를 크롤링하여 구직 활동을 필요로 하는 분들에게 전달할 외부용 메시지와 내부적으로 공유할 메시지를 자동완성 됩니다.  
